...
export default function Chat({userId, itemId}: {userId: string, itemId: string}){

  const navigate = useNavigate()

  const {getUsername, user, users, dataLoading, load_messages, send_message, fetch_conversation_id, read_messages, inbox, load_inbox, update_item_sold, load_items, get_item, delete_conversation} = useAppContext()
